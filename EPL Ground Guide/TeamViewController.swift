...
class TeamViewController: UITabBarController {
    ...
    func loadTeamData() {
        if teamName == "Arsenal" {
            ...
            stadiumLon = -0.105846
            teamCarInfo = "From M1, Junction 2, take the A1, towards Central London. Keep on the A1 until you see Holloway Road Tube Station on your right.  After the Tube Station turn left at the traffic lights into Hornsey Road, keep going until you reach the stadium. There is no parking at the ground or in nearby streets."
            ...
            teamCarInfo = "From the A31 take the A338 towards Bournemouth. Turn off the A338 (signposted Kings Park, Football Traffic), and at the roundabout turn left into Littledown Avenue and then the first right into Thistlebarrow Road. The ground is straight ahead."
            ...
            teamCarInfo = "From the M65 Junction 10 take the A679 towards Burnley. Turn right onto the B6240 (Trafalgar Street) and at the end of this road take the A682 (Centenary Way). At the next roundabout turn right into Yorkshire Street, which goes past the ground."
            ...
            stadiumLon = -3.203030
            teamCarInfo = "From the M4 Junction 33 take the A4232 towards Cardiff and stay on this road round Cardiff until you reach the B4267 (Leckwith Road). Leckwith Road runs past the ground."
            ...
            teamCarInfo = "Take the M4 towards London, which becomes the A4. After the Hammersmith flyover turn right into Earls Court Road. Go past Earls Court station and keep going until you reach the junction with Fulham Road. Turn right onto Fulham Road, and you should see the ground on your right."
            ...
            teamCarInfo = "At the end of the M62 take the A5058 towards Liverpool. Follow this road until you reach Walton Lane (A580), turn left onto Walton Lane and keep going until you reach the ground on your right."
            ...
            teamCarInfo = "Take the M4 towards London, which becomes the A4. Just before the Hammersmith Flyover turn off the A4 onto Hammersmith Broadway, and follow the road around central Hammersmith, once almost all the way round turn onto the A219 (Fulham Palace Road). Keep on the A219 and then turn right into Crabtree Lane, following this down to the ground."
            ...
            teamCarInfo = "Leave the M62 at Junction 25 (signposted Galpharm Stadium). At the motorway roundabout follow signs to Huddersfield East (A62), Dewsbury A64 onto the A644 Wakefield Road.  At Cooper Bridge Roundabout after one mile, turn right and follow Huddersfield (A62) signs through several sets of lights for three miles, and then turn left (signposted Galpharm Stadium) into St Andrews Road. At the lights turn left by the car showroom to the ground."
            ...
            teamCarInfo = "From the M1 Junction 21 take the A5460 (Narborough Road) towards Leicester. After going under the railway bridge turn right into Upperton Road, cross the river and turn right into Eastern Boulevard following this to the ground."
            ...
            teamCarInfo = "At the end of the M62 take the A5058 towards Liverpool. Follow this road until you reach Utting Avenue, turn left here and follow Utting Avenue to Anfield Road. Turn right on to Anfield Road for the ground."
            ...
            teamCarInfo = "Leave the M60 at Junction 23 and take the A635 towards Manchester. Turn off the A635 onto the Ashton New Road (A662). Stay on the A662 and the stadium is on the right just after the A6010."
            ...
            teamCarInfo = "Leave the M60 at Junction 9 and take the A5081 towards Manchester. Stay on the A5081 as it becomes Village Way, Wharfside Way, and finally Trafford Park Road. The ground is on the right hand side."
            ...
            stadiumLon = -1.622355
            teamCarInfo = "From the A1, take the A184 towards Newcastle. Stay on the dual carriageway, taking the Redheugh Bridge over the Tyne. Carry straight up on Blenheim Street towards the ground."
            ...
            teamCarInfo = "Leave the M25 at Junction 25 and take the A10 south into London. At the North Circular (A406) turn left onto the A406, and then turn off at the next junction onto Sterling Way.  After Silver Street Station turn right onto Fore Road (A1010) and keep on this road to the ground."
            ...
            teamCarInfo = "From the M1 Junction 5 take the A4008 towards Watford. At the second roundabout take the A411 into the town past Watford High Street Station. Turn right into Vicarage Road, following signs for Watford General Hospital to the ground."
            ...
            stadiumLat = 51.53867
            stadiumLon = -0.01649
            teamCarInfo = "Take the A12 towards London, and follow the signs to Stratford and Westfield. Turn off the A12 onto the A106, at the traffic lights keep left and staying in the left lane you automatically filter into Waterden Road. Stay on Waterden Road and follow the signs to Westfield Stratford City.\nThere is no official parking at the ground but you can park in the shopping centre."
