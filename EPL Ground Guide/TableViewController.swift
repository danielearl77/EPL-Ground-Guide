...
class TableViewController: UITableViewController {
    ...
    // MARK: Team List
    var Teams: [String] = ["Arsenal","Aston Villa","Bournemouth","Brentford","Brighton","Chelsea","Crystal Palace","Everton","Fulham","Leeds Utd","Leicester","Liverpool","Man City","Man Utd","Newcastle","Nottingham Forest","Southampton","Tottenham","West Ham","Wolves"]
